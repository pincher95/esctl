...
func FlattenSettingsMap(settings map[string]interface{}) map[string]any {
...
func flattenSettings(prefix string, settings map[string]interface{}, out map[string]any) {
