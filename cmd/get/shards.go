...
var getShardsCmd = &cobra.Command{
	Use:                   "shards [--index index] [--node node] [--shard shard] [--primary] [--replica] [--started] [--relocating] [--initializing] [--unassigned]",
	DisableFlagsInUseLine: true,
	Short:                 "Get shard information for the Elasticsearch cluster",
	Long: utils.Trim(`
